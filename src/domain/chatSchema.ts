...
export const ChatReplySchema = z.object({ reply: z.string().min(1), memory_writes: z.array(MemoryWriteSchema).default([]), plan_patch: PlanPatchSchema.nullable().default(null), safety: SafetySchema });
export type ChatReply = z.infer<typeof ChatReplySchema>;
export type PatchOp = z.infer<typeof PatchOpSchema>;

export const CHAT_JSON_SCHEMA = {
  type: 'object', additionalProperties: false, required: ['reply', 'memory_writes', 'plan_patch', 'safety'],
  properties: {
    reply: { type: 'string' },
